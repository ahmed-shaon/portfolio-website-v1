...
import { Mail, MapPin, Github, Linkedin, Twitter, Facebook, Instagram, Send, MessageSquare } from "lucide-react";
  ...
  return (
    <section id="contact" className="relative py-20 bg-black overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute bottom-1/4 rigth-1/4 w-96 h-96 bg-primary/20 opacity-30 rounded-full blur-3xl" />
            <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-primary/20 opacity-30 rounded-full blur-3xl" />
        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div >
                                ...
                                <input 
                                    ...
                                    onChange={handleChange} 
                                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300" 
                                    placeholder="your.email@gexample.com" 
                                />
                            </div>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-white/60 leading-relaxed">
                                I'm alway open to discussing new projects, creative ideas, or opportunities to be part of your visions. Feel free to reach out through any of the following methods:
                            </p>
                        </div>

                        <div className="space-y-4">
                            <div className="group relative bg-white/5 bordr border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                    ...
                                    Object.entries(SOCIAL_LINKS).slice(0,3).map(([platform, url]) => {
                                        ...
                                        return Icon ?(
                                            <a
                                                ...
                                                className="p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-primary/50 hover:scale-110 transition-all duratoin-300 group"
                                            >
