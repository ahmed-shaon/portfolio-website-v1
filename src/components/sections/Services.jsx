  ...
  return (
    <section id='services' className='relative py-20 bg-black overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
            ...
            <div className='absolute top-1/4 right-1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl' />
            ...
            <FadeIn delay={0}>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-lg text-white/60 max-w-xl mx-auto'>
                        Comprehensive solutions to tranform your ideas into exceptional digital experiences.
                    </p>
                </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6' >
                {
                    services.slice(0,2).map((service, index) => {
                        const IconComponent = Icons[service.icons] || Icons.Code;
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                {
                    services.slice(2).map((service, index) => {
                        const IconComponent = Icons[service.icons] || Icons.Code2;
