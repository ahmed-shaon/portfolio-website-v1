                        ...
                        <div className='grid grid-cols-3 gap-8'>
                            {
                                ABOUT_STATS.map((stat, index) => (
                                    <div key={index} className='relative'>
                                        <div className='absolute -left-4 top-0 w-1 h-full bg-linear-to-r from-primary via-primary/50 to-primary/20 rounded-full'></div>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                            ...
                            <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                               <div className='flex items-start gap-4'>
                                    ...
                                    <div className='flex-1'>
                                        <h3 className='text-lg fond-semibond text-white mb-2'>Experties</h3>
                                        <p className='text-sm text-white/70 leading-relaxed'>
                                            Specialized in building scalable webn applications with modern technologies and best practices.
                                        </p>
                                    </div>                                 
                               </div>
                            </div>
                        ...
                        <div className='relative group'>
                            ...
                            <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                ...
                                <p className='text-sm text-white/70 leading-relaxed'>
                                    Writing maintaiable, well-documented code that scaled
                                </p>
                            </div>
                        </div>
                        ...
                        <div className='relative group'>
                            ...
                            <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                ...
                                <p className='text-sm text-white/70 leading-relaxed'>
                                    Optimizaing for speed and efficiency in every project.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                <div className='grid grid-cols-3 gap-6 text-center'>
                                    <div>
                                        ...
                                        <div className='text-xs text-whtie/60'>client Satisfaction</div>
                                    </div>

                                    <div>
                                        <div className='text-2xl font-bold text-primary mb-1'>24/7</div>
                                        <div className='text-xs text-whtie/60'>Support Available</div>
                                    </div>

                                    <div className=''>
                                        <div className='text-2xl font-bold text-primary mb-1'>Fast</div>
                                        <div className='text-xs text-whtie/60'>Delivery Time</div>
                                    </div>
                                </div>
                            </div>
                        </div>
