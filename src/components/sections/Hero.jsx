      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <FadeIn delay={100}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight">Full Stack Developer Portfolio</h1>
            </FadeIn>

            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                I specialize in building modern, scalable web applications and high-performance backend systems using JavaScript, React, Node.js, PostgreSQL, and emerging technologies — turning innovative ideas into exceptional digital experiences.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              ...
              >
                <div className="relavtive z-10 bg-white text-[#212121] rounded-[17px] px-[26px] py-[13px] text-base font-medium border border-white">
                  Get in Touch
                </div>
              </button>
            </FadeIn>

            {/* Stats Section which is not require for me */}
            {/* <FadeIn delay={400}>
              <div className="grid grid-cols-2 md:grid-bols-4 gap-10 max-w-full">
                {
