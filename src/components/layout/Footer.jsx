                  ...
                  Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                    ...
                    return Icon ? (
                      <a
                        ...
                        className="group relative p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-primary/50 hover:scale-110 transiton-all duration-300"
