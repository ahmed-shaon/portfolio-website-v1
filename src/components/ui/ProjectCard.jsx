          ...
          <div className="flex flex-wrap gap-2">
            {
              technologies.map((tech, index) => (
                <span key={index} className="px-3 py-1 text-xs font-medium text-primary bg-primary/10 border-primary/20 rounded-lg hover:bg-primary/20 transition-colors duration-200">
                  {tech}
                </span>
              ))
            }
